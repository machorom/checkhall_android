...
public class IntroActivity extends AppCompatActivity {
    ...
    private void checkPermissions(){
        Log.d("CHPermission","checkPermissions permissionOffset="+permissionOffset);
    ...
    private void addCompletePermission(int reqeustID){
        Log.d("CHPermission","addCompletePermission "+reqeustID);
    ...
    private void checkPermission(final String permission, final String msg, final int requestID){
        ...
        if (ContextCompat.checkSelfPermission(this, permission)!= PackageManager.PERMISSION_GRANTED) {
            Log.d("CHPermission","checkPermission["+permission+"] request");
            // 이 권한을 필요한 이유를 설명해야하는가?
            if (ActivityCompat.shouldShowRequestPermissionRationale(this, permission)) {
                Log.d("CHPermission","checkPermission - shouldShowRequestPermissionRationale["+permission+"] true");
                ...
                Log.d("CHPermission","checkPermission - shouldShowRequestPermissionRationale["+permission+"] false");
            ...
            Log.d("CHPermission","checkPermission - not need");
            checkPermissions();
        }
    }
        ...
        switch (requestCode) {
            case MY_PERMISSIONS_REQUEST_READ_CONTACTS:
                if (grantResults.length > 0
                    ...
                    Log.d("CHPermission","onRequestPermissionsResult/MY_PERMISSIONS_REQUEST_READ_CONTACTS OK");
                } else {
                    Log.d("CHPermission","onRequestPermissionsResult/MY_PERMISSIONS_REQUEST_READ_CONTACTS reject");
                }
                break;
            case MY_PERMISSIONS_REQUEST_CALL_PHONE:
                if (grantResults.length > 0
                        && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                    Log.d("CHPermission","onRequestPermissionsResult/MY_PERMISSIONS_REQUEST_CALL_PHONE OK");
                } else {
                    Log.d("CHPermission","onRequestPermissionsResult/MY_PERMISSIONS_REQUEST_CALL_PHONE reject");
                }
                break;
            case MY_PERMISSIONS_REQUEST_WRITE_EXTERNAL_STORAGE:
                if (grantResults.length > 0
                        && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                    Log.d("CHPermission","onRequestPermissionsResult/MY_PERMISSIONS_REQUEST_WRITE_EXTERNAL_STORAGE OK");
                } else {
                    Log.d("CHPermission","onRequestPermissionsResult/MY_PERMISSIONS_REQUEST_WRITE_EXTERNAL_STORAGE reject");
                }
                break;
        }
        checkPermissions();
